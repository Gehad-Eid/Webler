	...
	<div class="login">
		<div class="form">
                              ...
                              <form name="form2" class="box" method="post">
                                 <div><h2>Manager Account <br> <p id="ph2">Sign in to your account</p></h2><p  style="font-size: 15px;margin: 10px;color: white; background:red; text-align: center;"><?php echo $error_msg; ?></p></div>
